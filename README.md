...
Open to backend engineering opportunities primarily in Go, Rust, or Python.

🔭 Building distributed systems and developer tooling
🌱 Exploring async Rust, concurrency patterns, and systems programming
⚡ Recent: Built [csc.nvim](https://github.com/yus-works/csc.nvim) - 37⭐, featured in [awesome-neovim](https://github.com/rockerBOO/awesome-neovim)
...
**What it does:** Aggregates remote software engineering jobs from multiple
APIs and RSS feeds into a unified interface with real-time updates,
...
### [csc.nvim](https://github.com/yus-works/csc.nvim) | Neovim Plugin (37⭐)
...
**What it does:** Analyzes your Git history to provide smart autocomplete for
commit scopes, ensuring consistency without config files.
...
- **Real user adoption**: 37 stars, community contributions, used in production workflows
...
**Learning:** Built this to solve my own workflow problem. Learned how to
design Neovim plugins, work with completion engines, and collaborate with OSS
communities. The experience of getting it accepted into awesome-neovim taught
me how OSS projects gain traction through ecosystem integration. When Saghen
contributed blink.cmp integration, it taught me how quality projects attract
contributions from ecosystem creators.
...
**What it does:** Crawls Wikipedia pages, extracts links, builds graph
structures, and visualizes relationships using D3.js.
...
I'm interested in **backend engineering roles** where I can work with:
